package com.meiyuan.catering.merchant.aop;
...
public class LogAspect {
    ...
    @Pointcut("execution(* com.meiyuan.catering.merchant.api..*.*(..))")
    public void log() {
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (args != null && args.length > 0 && !contentType.contains(CONTENT_TYPE_FILE)) {
            // - 有参数，并且不是文件上传
            String[] parameterNames = signature.getParameterNames();
            Object formatParams = getParams(parameterNames, args);
            params = formatJson(JsonUtil.toJson(formatParams));
