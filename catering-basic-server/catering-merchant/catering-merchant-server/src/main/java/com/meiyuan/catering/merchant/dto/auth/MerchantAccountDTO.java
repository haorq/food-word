...
public class MerchantAccountDTO extends IdEntity implements Serializable {

        private static final long serialVersionUID = 5903432458810961828L;

        @ApiModelProperty(value = "登陆电话",hidden = true)
        private String phone;

        @ApiModelProperty(value = "账号类型 ：1：品牌/商家，2：店铺，3：自提点，4：商家兼自提点，5：员工",hidden = true)
        private Integer accountType;

        @ApiModelProperty(value = "账号类型对应id【员工登录时对应id为店铺id】",hidden = true)
        @JsonFormat(shape = JsonFormat.Shape.STRING)
        private Long accountTypeId;

        @ApiModelProperty(value = "退出登陆状态【1.5.0】",hidden = true)
        ...
        @ApiModelProperty(value = "账户状态:1:启用，2：禁用",hidden = true)
        private Integer accountStatus;

        @ApiModelProperty(value = "最近一次登录时间",hidden = true)
        private LocalDateTime lastLoginTime;

        @ApiModelProperty(value = "账号权限 : merchant,shop,pickup,shopAndPickup",hidden = true)
