...
public class MerchantDetailDTO {
    ...
    @ApiModelProperty(value = "id修改时必传")
    private Long id;
    ...
    @ApiModelProperty(value = "来源：1- 商户申请 2-平台添加")
    ...
    @ApiModelProperty(value = "商户状态：1- 禁用 2-启用")
    ...
    @ApiModelProperty("品牌下属门店")
    private IPage<CateringMerchantPageVo> shopList;
}
