...
/**
 * 退款订单审核表(CateringOrdersRefundAudit)实体类
 *
 * @author xie-xi-jie
 * @since 2020-03-16 11:14:35
 */
@Data
@TableName(value = "catering_orders_refund_audit", autoResultMap = true)
public class CateringOrdersRefundAuditEntity extends IdEntity {
    private static final long serialVersionUID = -11784252247411163L;
