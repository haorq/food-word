...
public class GpsCoordinateUtils {
    ...
    private final static double D72_004 = 72.004;
    private final static double D137_8347 = 137.8347;
    private final static double D0_8293 = 0.8293;
    private final static double D55_8271 = 55.8271;
     ...
     * @return 经度, 纬度
     */
    public static String calGCJ02toBD09(String location) {
    ...
    public static boolean isOutOfChina(double latitude, double longitude, boolean precision) {
        if (precision) {
            ...
            if (longitude < D72_004 || longitude > D137_8347) {
                return true;
            }
            if (latitude < D0_8293 || latitude > D55_8271) {
                return true;
            }
            return false;
        }
    ...
    private static boolean pointInPolygon(Point[] polygon, double latitude, double longitude) {
        ...
        for (i = 0; i < polygon.length; i++) {
            boolean b = (polygon[i].getLatitude() < latitude && polygon[j].getLatitude() >= latitude
