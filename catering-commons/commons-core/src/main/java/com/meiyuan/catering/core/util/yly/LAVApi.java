...
public class LAVApi {
     ...
     * @return
     */
    public static String print(String client_id, String access_token, String machine_code, String content, String origin_id, String sign, String id, String timestamp,String printName) {
        HashMap hashMap = new HashMap();
        hashMap.put("client_id", client_id);
        ...
        hashMap.put("id", id);
        hashMap.put("timestamp", timestamp);
        hashMap.put("print_name",printName);
